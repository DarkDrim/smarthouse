...
/*
	...
	private void setFieldValues() {
		...
		if (pMap.get("DescriptionText")!=null)
			mDescText.setText(pMap.get("DescriptionText").toString());
		...
		if (pMap.get("InvalidValueText")!=null)
			mInvalidValueText.setText(pMap.get("InvalidValueText").toString());

		if (pMap.get("SelectedImage")!=null) {
			// Выбор изображения для пункта меню
			int pos = mImages.indexOf(pMap.get("SelectedImage").toString());
		...
		if (pMap.get("IncomingValueFormula")!=null)
			mIncomingValueFormula.setText(pMap.get("IncomingValueFormula").toString());
				
		// Количество знаков после запятой
		EditText mFractionDigits = (EditText) findViewById(R.id.decimal_places_text);
		if (pMap.get("FractionDigits")!=null)
			mFractionDigits.setText(pMap.get("FractionDigits").toString());
		...
		if (pMap.get("OutgoingValueFormula")!=null)
			mOutgoingValueFormula.setText(pMap.get("OutgoingValueFormula").toString());
		...
		if (pMap.get("OutgoingValueValidation")!=null)
			mOutgoingValueValidation.setText(pMap.get("OutgoingValueValidation").toString());
		...
		if (pMap.get("GiveMeValueMessage")!=null)
			mGiveMeValueMessage.setText(pMap.get("GiveMeValueMessage").toString());
		...
		if (pMap.get("OutgoingValueMessage")!=null)
			mOutgoingValueMessage.setText(pMap.get("OutgoingValueMessage").toString());
	}
