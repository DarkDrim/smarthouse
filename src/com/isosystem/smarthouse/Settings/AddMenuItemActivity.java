...
public class AddMenuItemActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mEditMode) {
			...
			View divider = (View) findViewById(R.id.divider_add_to_menu);
	...
	private void setFieldValues() {
		...
		if (pMap != null) {
			if (pMap.get("GridImage")!=null) {
				...
				int pos = mImages.indexOf(pMap.get("GridImage").toString());
	...
	private Boolean validateFields() {
		...
		if ((typeMenu.isChecked() == false) && (typePoint.isChecked() == false)) {
