...
public class ApplicationPreferencesActivity extends PreferenceActivity
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Preference passwordChangePreference = (Preference) findPreference("password_change");

		Preference testFSPreference = (Preference) findPreference("formatted_screen_test");
	 ...
	 */
	class PasswordChangeDialog extends DialogFragment {
