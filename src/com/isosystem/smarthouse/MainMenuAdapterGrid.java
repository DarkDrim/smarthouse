		...
		return new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				case SendMessage:
					...
					String hdr = pMap.get("HeaderText").toString();
					String desc = pMap.get("DescriptionText").toString();
					String msg = pMap.get("OutgoingValueMessage").toString();
...
//			grd.setVerticalSpacing(grd.getHorizontalSpacing());
		...
		if (pMap.containsKey("GridImage")) {
			File imageFile = new File(pMap.get("GridImage").toString());
